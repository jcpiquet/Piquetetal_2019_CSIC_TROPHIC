...
foo_table<-cbind(may=apply(foo_table[,c(1:5,16:20,31:35)],1,sum),
                 ...
                 nov=apply(foo_table[,c(11:15,26:30,41:45)],1,sum)) # calculating                                                                       # number of                                                                         # samples where
                                                                    # each order is
                                                                    # present
...
We now obtain pecentage of occurrence.
...
data$cluster<-recode_factor(data$cluster,'1'="high",'3'="moderate",'2'="low")
